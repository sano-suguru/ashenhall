...
export const sampleDecks: SampleDeck[] = [
  ...
  // 5. 審問官「烙印の審判」
  {
    name: '烙印の審判',
    faction: 'inquisitor',
    coreCardIds: ['inq_sin_burden', 'inq_sanctuary_guard'],
    cardIds: [
      'inq_sin_burden', 'inq_sin_burden', 'inq_sin_burden',
      'inq_sanctuary_guard', 'inq_sanctuary_guard', 'inq_sanctuary_guard',
      'inq_repentant_succubus', 'inq_repentant_succubus',
      'inq_collective_confession', 'inq_collective_confession',
      'inq_chain_of_faith', 'inq_chain_of_faith',
      'inq_venomtongue', 'inq_venomtongue',
      'inq_pyre', 'inq_pyre',
      'inq_heretical_inquisition', 'inq_heretical_inquisition',
      'inq_divine_punisher',
      'inq_stone_guardian',
    ],
  },
