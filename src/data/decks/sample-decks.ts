...
export const sampleDecks: SampleDeck[] = [
  ...
  // 5. 審問官「迅速なる審判」
  {
    ...
    cardIds: [
      'inq_repentant_succubus', 'inq_repentant_succubus', 'inq_repentant_succubus',
      'inq_venomtongue', 'inq_venomtongue',
      'inq_sin_burden',
      'inq_writ_of_silence', 'inq_writ_of_silence', 'inq_writ_of_silence',
      'inq_verdict_of_conviction', 'inq_verdict_of_conviction', 'inq_verdict_of_conviction',
      'inq_collective_confession', 'inq_collective_confession',
      'inq_divine_punisher', 'inq_divine_punisher',
      'inq_truth_extractor', 'inq_truth_extractor',
      'inq_judgment_angel',
      'inq_purifying_flame',
    ],
  },
