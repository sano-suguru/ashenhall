    ...
    <div className="pointer-events-none select-none">
      <div className="w-24 h-32 relative">
        <div className="absolute inset-0 rounded-lg border border-red-400/60 bg-red-900/30 backdrop-blur-sm animate-pulse opacity-80">
          ...
          <div className="absolute bottom-1 left-1 text-xs font-semibold text-yellow-300">
            {snapshot.attackTotal}
          </div>
          <div className="absolute bottom-1 right-1 text-xs font-semibold text-green-300">
